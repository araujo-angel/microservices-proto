...
const (
	Shipping_Calculate_FullMethodName = "/Shipping/Calculate"
)
...
type ShippingClient interface {
	Calculate(ctx context.Context, in *CalculateShippingRequest, opts ...grpc.CallOption) (*CalculateShippingResponse, error)
}
...
func (c *shippingClient) Calculate(ctx context.Context, in *CalculateShippingRequest, opts ...grpc.CallOption) (*CalculateShippingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CalculateShippingResponse)
	err := c.cc.Invoke(ctx, Shipping_Calculate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShippingServer interface {
	Calculate(context.Context, *CalculateShippingRequest) (*CalculateShippingResponse, error)
...
func (UnimplementedShippingServer) Calculate(context.Context, *CalculateShippingRequest) (*CalculateShippingResponse, error) {
...
func _Shipping_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CalculateShippingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingServer).Calculate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shipping_Calculate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingServer).Calculate(ctx, req.(*CalculateShippingRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Shipping_Calculate_Handler,
		},
	},
